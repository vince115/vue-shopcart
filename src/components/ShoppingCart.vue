<template>
  <div>
    <button class="btn btn-primary mb-3 mb-md-0 ml-md-3" data-toggle="modal" data-target="#shoppingCart">Cart ({{ numInCart }})</button>
...
<script>
import { dollars } from '../assets/js/filters.js';
export default {
  name: 'shoppingCart',
  computed: {
